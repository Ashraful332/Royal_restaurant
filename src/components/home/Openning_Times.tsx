const Opening_Times = () => {
    return (
        <div className="mt-[var(--margin-high)] mb-high flex justify-center max-w-[1170px] mx-auto">
        <div className="flex w-full max-w-[1000px] h-[423px]">
            ...
            <div className="w-1/2 h-full bg-[var(--primary)] text-black flex flex-col px-6 py-6">
