...
const Our_Blog = () => {
    return (
        <div className="flex-center mt-high max-w-[1170px] h-auto  mx-auto pt-4">
            ...
            <div className=" flex flex-col lg:flex-row items-center lg:items-start gap-10 mb-sec ">
                ...
                <div className="w-auto md:w-[50%] ">
                    <p>August 6, 2025</p>
                    <h3 className="text-white font-bold text-lg md:text-2xl mt-2 mb-4 ">The Most Expensive Cup of Coffee in the Usa</h3>
                    <p className="text-[#ffffffef] text-sm sm:text-lg ">
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center lg:items-start gap-10 mb-sec ">
                <div className="w-auto md:w-[50%] mx-auto h-auto sm:h-[357px] overflow-hidden object-center relative ">
